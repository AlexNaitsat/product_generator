...
namespace UnityTemplateProjects
{
    public class SimpleCameraController : MonoBehaviour
    {
        ...
        //I added  selection of  camera views to get shapenet_plain data format
        ...
        void Update()
        {
            //change camera position according to the select view 
            //this script is attached to the MainCamera, thus I can reference camera via 'gameObject'
            // switch(cameraView){
            ...
            //     {
            //         //rotate camera by 180 deg around Y to get reflected view point
            //         Debug.Log("Camera Position before=");
            ...
            //         Debug.Log("Camera Position after=");
            //         //Debug.Log(gameObject.transform.position);
            //         Debug.Log(transform.position);
